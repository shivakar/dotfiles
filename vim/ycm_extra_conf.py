...
def FlagsForBuildVendorIncludes(rootdir):
    build_path = "."
    try:
        build_path = FindNearest(rootdir, 'build')
    except Exception as e:
        return []

    return [
        '-I' + os.path.join(root, 'include') for root, dir, files in os.walk(build_path)
        if 'include' in dir
    ]
...
def FlagsForFile(filename):
    ...
    if compilation_db_flags:
        ...
        build_include_flags = FlagsForBuildVendorIncludes(root)
