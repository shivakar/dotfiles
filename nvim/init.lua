...
if system_name == "Linux" then
  lua_ls_cmd = {
    "/opt/lsp/lua-language-server/latest/bin/lua-language-server",
    "-E",
    "/opt/lsp/lua-language-server/latest/main.lua",
...
-- Set F8 to toggle line numbers
vim.api.nvim_set_keymap('n', '<F8>', ':set invnumber<CR>', { noremap = true, silent = true })
...
-- don't show number in terminals
